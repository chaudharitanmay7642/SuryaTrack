    ...
    <div className="app-root">
      ...
      <main className="main-content">
        ...
        <Hero 
          ...
          onCheckRulesByDate={() => setComparisonModalOpen(true)}
          onViewLatestScheme={() => scrollTo('schemes')}
          onViewWhatChanged={() => setComparisonModalOpen(true)}
        />
        ...
        <FeatureCards 
          ...
          onViewComparison={() => setComparisonModalOpen(true)}
        ...
        <section className="dashboard-triad-section" aria-label="Interactive Dashboard">
          <div className="dashboard-triad-grid">
            ...
            <RecentTimeline 
              translations={currentT}
              onOpenTimelineModal={() => setComparisonModalOpen(true)}
            />
            ...
            <SearchByState 
              ...
              selectedState={selectedState}
              setSelectedState={setSelectedState}
              onViewStateDetails={() => setComparisonModalOpen(true)}
            />
