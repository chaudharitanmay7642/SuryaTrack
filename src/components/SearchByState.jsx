...
export function SearchByState({ 
  ...
  // Find the selected state data or fallback
  const currentState = statesData.find(s => s.name === selectedState) || statesData[0]
    ...
    <div className="dashboard-widget state-widget" id="schemes">
      ...
      <div className="state-display-split">
          ...
          <div className="map-zoom-hint">
            {isZoomedIn ? (
              <span className="hint-pill zoomed">
                <span className="dot pulse">●</span> Focused on {currentState.name}
              </span>
            ) : (
              <button 
                className="hint-pill default-click" 
                onClick={() => handleZoomToState(currentState.name)}
              >
                🔍 Click to zoom into {currentState.name}
              </button>
            )}
          </div>
        </div>
        ...
        <div className="state-info-card">
          ...
          <div className="state-specs-list">
            <div className="spec-item">
              <span className="spec-icon">⚙️</span>
              <div className="spec-text">
                <span className="spec-label">{translations.discomLabel}:</span>
                <span className="spec-val">{currentState.discom}</span>
              </div>
            </div>
            ...
            <div className="spec-item">
              ...
              <div className="spec-text">
                ...
                <span className="spec-val">{currentState.scheme}</span>
              </div>
            </div>
            ...
            <div className="spec-item">
              ...
              <div className="spec-text">
                ...
                <span className="spec-val highlight-version">{currentState.version}</span>
              </div>
            </div>
            ...
            <div className="spec-item">
              ...
              <div className="spec-text">
                ...
                <span className="spec-val">{currentState.effectiveDate}</span>
              </div>
            </div>
          </div>
