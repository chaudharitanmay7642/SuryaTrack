    ...
    <div className="dashboard-widget timeline-widget" id="timeline">
      ...
      <div className="timeline-stepper">
        ...
        <div className="stepper-nodes">
          {policyVersions.map((item, idx) => (
            <div key={item.version} className={`stepper-node node-${item.version.toLowerCase()}`}>
      ...
      <div className="timeline-caption">
        <span className="caption-dot active">●</span> Active Policy: <strong>Version 2 (Apr 2026)</strong> — PM-Surya Ghar Standardized Grid Rules.
      </div>
    </div>
  )
}
